...
import authStylist from "../backend/middleware/authStylist.js";

describe("Stylist Authentication Middleware Tests", () => {
    let sandbox;
    ...
    it("should allow access when a valid stylist token is provided", async () => {
        ...
        await authStylist(req, res, next);
        expect(req.body.stylistId).to.equal("12345"); // ✅ Check if stylistId is assigned
